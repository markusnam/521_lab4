...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_chnam>
...
<https://github.com/markusnam/521_lab4/deployments/activity_log?environment=github-pages>
...
```{r, echo=2:3}
print("`echo` specifies which row(s) of code will be shown. In this example, the first row of the code is not shown.")
print("Only the 2nd row")
print("and the 3rd row are shown")
```
...
```{r, highlight=FALSE, collapse=TRUE}

myfunc <- function () {
    print("1. Syntax highlighting is off in this code chunk.")
    print("2. Output and code are shown in a single block.")
}
...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_chnam/blob/master/q7.html>

<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_chnam/blob/master/q7.pdf>
...
<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_chnam/blob/master/q8_canlang_summary.Rmd>

<https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_chnam/blob/master/q8_canlang_summary.html>
...
`.md` is rendered perfectly on `github` as opposed to `.html` which is
shown as raw html code.
...
<https://markusnam.github.io/521_lab4/>
...
Advantages of using reproducible tools (e.g. R Markdown and Jupyter)

-   Documents are in plain text file which can be easily edited by using the simplest editor such as `notepad` or `vi`.

-   Support of code chunks/cells allows dynamically generate tables/figures/etc.

-   Multiple languages are supported (e.g. `Python` and `R`).

-   Support of LaTeX enables easier editing of Mathematical formula.

-   Multiple output formats are supported (e.g. `.html`, `.pdf` and `.md`) \* Markdown codes are simple and human readable.

Disadvantages of using reproducible tools

-   Not as "what you see is what you get" as non-reproducible tools (e.g. Word and Powerpoint).

-   Not as commonly used by the public (e.g. in a business organization).

-   Implementations of markdown have diverged. i.e. output is not unified even if the same markdown is used.

-   Too many versions of markdown with slight differences. i.e. not friendly to non-tech users.
